...
| 2. **Conditional INSERT** | `INSERT...SELECT...WHERE NOT EXISTS` (or `ON CONFLICT DO NOTHING` for PostgreSQL) | Prevents inserting a duplicate lock if another process just acquired it |
